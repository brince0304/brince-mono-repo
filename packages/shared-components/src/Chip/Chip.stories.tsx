...
const meta: Meta<typeof Chip> = {
    ...
    argTypes: {
        text: { control: 'text' },
        color: {
            control: { type: 'select', options: ['blue', 'green', 'red', 'yellow', 'purple', 'gray', 'slate', 'zinc', 'neutral', 'stone'] },
        },
...
export const AllColors = () => (
    <div className="flex flex-wrap gap-2">
        {['blue', 'green', 'red', 'yellow', 'purple', 'gray', 'slate', 'zinc', 'neutral', 'stone'].map((color) => (
            // @ts-ignore
...
export const WithIcon = () => (
    <Chip text="With Icon" icon={<Tag className="w-4 h-4 mr-1.5" />} />
);

export const WithTag = () => (
    <Chip text="With Tag" tag={true} />
);