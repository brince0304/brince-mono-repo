...
const ProfileCard = () => {
	return (
		<motion.div
			...
			className="w-full mx-auto p-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-xl shadow-lg"
		>
			<div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
				...
				<div className="flex-1 text-center md:text-left">
					...
					>
						주니어 프론트엔드 개발자 백석현입니다. 9년간의 댄서 생활을 하면서
						무대에서 관객과 소통하던 경험을 살려, 이제는 사용자와 '대화'하는
						웹사이트를 만들고 있습니다. 제 코드가 단순한 기능 구현을 넘어
						사용자에게 의미 있는 경험을 전달할 수 있기를 항상 고민합니다.
					</motion.p>
